          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>
                        @if($banner->photo)
                            <img src="{{ asset('images/banners/' . $banner->photo) }}" class="img-fluid" style="max-width:80px" alt="{{$banner->photo}}">
                        @else
                            <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid" style="max-width:100%" alt="avatar.png">
                        @endif
                    </td>
                    <td>
