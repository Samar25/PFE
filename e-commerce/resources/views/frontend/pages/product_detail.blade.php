												...
												<ul class="slides">
													...
													@foreach($photo as $data)
														<li data-thumb="{{$data}}" rel="adjustX:10, adjustY:">
															<img src="{{ asset('images/products/' . $product_detail->photo) }}" alt="{{$data}}">
														</li>
													@endforeach
												</ul>
											</div>
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">${{number_format($after_discount,2)}}</span>     </p>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
											...
											@endphp
                                            <img class="default-img" src="{{ asset('images/products/' . $product->photo) }}" alt="{{$photo[0]}}">
                                            <img class="hover-img" src="{{ asset('images/products/' . $product->photo) }}" alt="{{$photo[0]}}">
                                        </a>
